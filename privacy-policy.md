---
layout: default
title: Privacy Policy — Tashika
---

# Privacy Policy — Tashika
...
Tashika is developed and operated by Ash Every Design Office (Ashley Every), based in Yamanashi, Japan. For the purposes of applicable data protection laws, including the General Data Protection Regulation (GDPR), Ash Every Design Office acts as the **Data Controller** of your personal data.

**Contact:** hello@aedo.jp
**Location:** Yamanashi, Japan

This Privacy Policy explains how Tashika handles your information when you use our app. We have written this in plain language because we believe privacy policies should be readable by the people they protect.
...
- **We do not show ads.** Tashika is a one-time purchase with no advertising.

---

## 1. What data Tashika processes

### 1a. Images you scan (camera data)

When you use Tashika's scanning feature, your device's camera captures an image of the food item, menu, or packaging you are pointing at. This image is:
...
- **Not stored by Tashika after analysis**
- **Not stored by Google after analysis** (as per Google's Gemini API terms)

**Purpose:** To provide the core functionality of Tashika — translating Japanese food content into your chosen language.
...
Tashika stores the following information locally on your device using AsyncStorage (device-level storage). This data never leaves your device and is never transmitted to us or any third party:
...
Tashika's core functionality depends on sending your food images to Google's Gemini AI service. Here is exactly what this means:
...
To be explicitly clear, Tashika does not collect:
...
When you use Tashika's scanning feature, your food images are transmitted to Google's servers, which may be located outside Japan, Australia, or your home country. This transfer is necessary for the app to function.
...
**All users:**
- You can stop using Tashika at any time, which ends all data processing
...
*Note: Because Tashika does not collect personal data that identifies you, many of these rights have limited practical application. We do not hold a profile of you that can be accessed, corrected, or deleted. Your scan images are not retained.*
...
- All communications between Tashika and Google's Gemini API use HTTPS encryption
...
Tashika is not directed at children under the age of 13 (or 16 in the EU). We do not knowingly collect personal information from children. If you are a parent or guardian and believe your child has used Tashika without appropriate supervision, please contact us at hello@aedo.jp.

Users under 18 must use Tashika under the supervision of a parent or legal guardian, as outlined in our Terms of Service.

---

## 9. Third-party services

Tashika uses the following third-party services:
...
Tashika does not use cookies. Tashika does not track your behaviour across other apps or websites. Tashika does not use advertising identifiers or participate in any advertising network.
...
Continued use of Tashika after changes are posted constitutes acceptance of the revised policy.
